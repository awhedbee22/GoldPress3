<!-- nav -->
<!-- <nav id="navigation" class="nav main-navigation singlelevel" role="navigation">
    <?php html5blank_nav(); ?>
</nav> -->
...
<nav id="navigation" class="main-navigation singlelevel auto-highlight">
    <ul id="nav_list" class="top-level-nav">
        ...
        <li class="nav-item">
            <a href="/getting-started.html" class="first-level-link"><span class="ca-gov-icon-gear" aria-hidden="true"></span>Getting Started</a>
        </li>
        <li class="nav-item">
            <a href="/structure.html" class="first-level-link"><span class="ca-gov-icon-flowchart" aria-hidden="true"></span>Structure</a>
        </li>
        <li class="nav-item">
            <a href="https://webstandards.ca.gov/" class="first-level-link" target="_blank"><span class="ca-gov-icon-state" aria-hidden="true"></span>Web Standards</a>
        </li>
        <li class="nav-item">
